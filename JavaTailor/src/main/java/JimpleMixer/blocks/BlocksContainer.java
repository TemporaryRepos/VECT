...
//            sum += blockMutants.size();
//            for (BlockInfo blockMutant : blockMutants) {
//                if(blockMutant.getClass().getName().toLowerCase(Locale.ROOT).contains("if")){
//                    ifs++;
//                }
//                else if(blockMutant.getClass().getName().toLowerCase(Locale.ROOT).contains("loop")){
//                    loops++;
//                }
//                else if(blockMutant.getClass().getName().toLowerCase(Locale.ROOT).contains("switch")){
//                    switchs++;
//                }
//                else if(blockMutant.getClass().getName().toLowerCase(Locale.ROOT).contains("trap")){
//                    traps++;
//                }
//                else if(blockMutant.getClass().getName().toLowerCase(Locale.ROOT).contains("return")){
//                    returns++;
//                }
//                else {
//                    seqs++;
